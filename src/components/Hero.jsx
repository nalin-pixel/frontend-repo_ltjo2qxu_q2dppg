  ...
  return (
    <section id="home" className="relative min-h-[92vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* gradient and pattern overlays that keep scene interactive */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/60 via-black/60 to-black/95" />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(600px_200px_at_20%_0%,rgba(56,189,248,0.18),transparent)]" />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(600px_200px_at_80%_100%,rgba(217,70,239,0.14),transparent)]" />
      </div>

      {/* Content */}
      <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-7xl flex-col items-start justify-center px-4">
        <motion.div
        ...
        >
          <p className="mb-3 inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-black/40 px-3 py-1 text-xs text-cyan-300/90 shadow-[0_0_40px_rgba(0,255,255,0.15)]">
            <span className="h-1.5 w-1.5 rounded-full bg-cyan-400" /> Currently at Teknikforce Ventures LLC
          </p>
          ...
          <p className="mt-4 text-base leading-relaxed text-white/80 sm:text-lg">
            Building scalable SaaS, cloud, and AI-driven platforms.
          </p>
      ...
      {/* subtle bottom parallax glow */}
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-[radial-gradient(50%_60%_at_50%_100%,rgba(56,189,248,0.25),transparent)]" />
    </section>
  );
}
